...
const Store = (() => {
  ...
  function isInitialized() {
    return get('engine_initialized') === true;
  }

  function markInitialized() {
    set('engine_initialized', true);
  }

  function resetAll() {
    const keys = Object.keys(localStorage).filter(k =>
      k.startsWith('engine_') || k.startsWith('avengineos_') || k.startsWith('windsor_')
    );
